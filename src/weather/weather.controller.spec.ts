...
describe('WeatherController', () => {
  ...
  const mockService = {
    ...
    getById: jest.fn().mockResolvedValue(mockWeather),
    update: jest.fn().mockResolvedValue({ ...mockWeather, city: 'Updated' }),
  ...
  it('should get one weather', async () => expect(await controller.getOne('1')).toEqual(mockWeather));
  it('should update weather', async () => expect(await controller.update('1', mockDto)).toEqual({ ...mockWeather, city: 'Updated' }));
